    ...
    <div class="card  text-center" id="cardRegis">
        ...
        <div class="card-body ">
            <form id="registrationForm" method="POST" action="function.php?act=register" class="needs-validation" novalidate>
                ...
                <button style="margin-top: 20px" type="submit" name="submitButton" id="submitButton" class="btn btn-success">Register</button>
                <br>
                <div class="container signin">
                    <p style="margin-top: 20px;">Sudah punya akun? <a href="login.php">Log In</a></p>
                </div>
            </form>
        </div>
    </div>
